        ...
        <div className="w-3/4 m-4">
          ...
          <div className="w-4/5 flex">
            <div className="w-2/4 flex">
              ...
              <div className="w-full text-white-600 text-sm font-textFont whitespace-nowrap ml-2">
            ...
            <div className="w-1/4 flex">
              <button className="text-white bg-red-500 rounded-full h-9 w-40">
                Subscribe
              </button>
            ...
            <div className="w-1/4 flex">
              <div class="bg-gray-800 text-white px-4 rounded-full flex items-center h-9">
                <svg
                  width="28"
                  height="28"
                  viewBox="0 0 28 28"
